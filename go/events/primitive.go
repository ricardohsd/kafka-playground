...
func readVehicleUpdated(r io.Reader) (*VehicleUpdated, error) {
	var str = &VehicleUpdated{}
	var err error
	str.Id, err = readString(r)
	if err != nil {
		return nil, err
	}
	str.Latitude, err = readDouble(r)
	if err != nil {
		return nil, err
	}
	str.Longitude, err = readDouble(r)
	if err != nil {
		return nil, err
	}
	str.Producer, err = readString(r)
	if err != nil {
		return nil, err
	}
	str.CreatedAt, err = readLong(r)
	if err != nil {
		return nil, err
	}
	str.Comments, err = readString(r)
	if err != nil {
		return nil, err
	}
...
func writeVehicleUpdated(r *VehicleUpdated, w io.Writer) error {
	var err error
	err = writeString(r.Id, w)
	if err != nil {
		return err
	}
	...
	err = writeString(r.Producer, w)
	if err != nil {
		return err
	}
	err = writeLong(r.CreatedAt, w)
	if err != nil {
		return err
	}
	err = writeString(r.Comments, w)
	if err != nil {
		return err
	}
